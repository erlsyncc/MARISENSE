...
<main class="main-content">
    ...
    <div class="data-card">
        ...
        <div class="table-paginator" id="txPaginator">
            <div style="display:flex;align-items:center;gap:10px;">
                <span class="page-info" id="txPageInfo"></span>
                <select class="page-size" id="txPageSize">
                    <option value="10" selected>10 / page</option>
                    <option value="25">25 / page</option>
                    <option value="50">50 / page</option>
                </select>
            </div>
            <div class="page-nav" id="txPageNav"></div>
        </div>
    ...
    <div class="data-card">
        ...
        <div class="table-paginator" id="pendingPaginator">
            <div style="display:flex;align-items:center;gap:10px;">
                <span class="page-info" id="pendingPageInfo"></span>
                <select class="page-size" id="pendingPageSize">
                    <option value="10" selected>10 / page</option>
                    <option value="25">25 / page</option>
                    <option value="50">50 / page</option>
                </select>
            </div>
            <div class="page-nav" id="pendingPageNav"></div>
        </div>
...
/* ══════════════ TABLE PAGINATION ══════════════ */
function setupPagination(tableId, pageInfoId, pageNavId, pageSizeId) {
    ...
    const pageNav = document.getElementById(pageNavId);
...
setupPagination('txTable', 'txPageInfo', 'txPageNav', 'txPageSize');
setupPagination('pendingTable', 'pendingPageInfo', 'pendingPageNav', 'pendingPageSize');
</script>
    ...
    <div class="help-modal">
        ...
        <div class="help-section">
            ...
            <div class="help-item">
                ...
                <div><div class="help-item-title">Sea Conditions</div><div class="help-item-desc">View live buoy_data telemetry and trend charts used for customer-facing sea condition status.</div></div>
            </div>
            <div class="help-item">
