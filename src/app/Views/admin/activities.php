...
<main class="main-content">
    ...
    <div class="layout-row">
        ...
        <div class="panel">
            ...
            <div class="table-paginator" id="activitiesPaginator">
                <div style="display:flex;align-items:center;gap:10px;">
                    <span class="page-info" id="activitiesPageInfo"></span>
                    <select class="page-size" id="activitiesPageSize">
                ...
                <div class="page-nav" id="activitiesPageNav"></div>
            </div>
        </div>
...
(function () {
    ...
    if (!list) return;
    const allRows = Array.from(list.querySelectorAll('.act-row'));
    if (!allRows.length) return;
    const pageInfo = document.getElementById('activitiesPageInfo');
    const pageNav = document.getElementById('activitiesPageNav');
    const pageSizeSelect = document.getElementById('activitiesPageSize');
    let currentPage = 1;
