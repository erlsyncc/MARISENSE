...
<div class="help-overlay" id="helpOverlay" onclick="if(event.target===this) this.classList.remove('open')">
    <div class="help-modal">
        ...
        <div class="help-section">
            ...
            <div class="help-item"><div class="help-item-icon"><i class="fa-solid fa-tower-broadcast"></i></div><div><div class="help-item-title">Sea Conditions</div><div class="help-item-desc">View live buoy_data telemetry and trend charts used for customer-facing sea condition status.</div></div></div>
